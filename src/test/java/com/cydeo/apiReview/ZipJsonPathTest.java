...
And body should contains following information
    ...
    */
    ...
    public void test(){
        ...
        assertEquals("United States",js.getString("country"));
        List<String> expectedZips = new ArrayList<>(Arrays.asList("02178","02478"));
        List<String> actualZips = js.getList("places.\'post code\'");
        assertEquals(expectedZips,actualZips);
        assertEquals("[42.4464, 42.4128]", js.getString("places.latitude"));
        ...
        String actualLatitude  = js.getString("places.findAll {it.\'post code\'==\"02178\"}.latitude");
